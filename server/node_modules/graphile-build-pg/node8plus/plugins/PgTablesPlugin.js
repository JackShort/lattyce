...
exports.default = function PgTablesPlugin(builder, { pgForbidSetofFunctionsToReturnNull = false }) {
  ...
  builder.hook("init", (_, build) => {
    ...
    introspectionResultsByKind.class.forEach(table => {
      const tablePgType = introspectionResultsByKind.type.find(type => type.type === "c" && type.category === "C" && type.namespaceId === table.namespaceId && type.classId === table.id);
      if (!tablePgType) {
        throw new Error("Could not determine the type for this table");
      }
      const arrayTablePgType = introspectionResultsByKind.type.find(type => type.arrayItemTypeId === tablePgType.id);
      /*
        table =
          { kind: 'class',
            id: '6484790',
